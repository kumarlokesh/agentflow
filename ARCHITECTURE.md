...
- **Coverage target**: ≥80% for all packages (currently: root 90%, policy 98%, multi 97%, observe 96%, memory 95%, schema 94%, store 89%, replay 80%)
